/* HomeKit QR Code
 * Generated with:
 *  npx homekit-code qrcode --pairingCode=25102023 --setupId=RTGO --category=garage --zoom=1 --output=svg
 * and then adding width="200" to the svg tag.
 * See https://github.com/simongolms/homekit-code
 * 
 * For explanation of the R"==( ... )=="
 * See https://www.stroustrup.com/C++11FAQ.html#raw-strings
 */
R"==(
<svg viewBox="0 0 400 540" xmlns="http://www.w3.org/2000/svg" width="200">
